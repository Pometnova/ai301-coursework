...
My background is data analysis: SQL queries, cleaning data with pandas and NumPy, and building charts with matplotlib, seaborn, and Plotly. I have also done basic web scraping with BeautifulSoup. I am a beginner at software engineering: new to Git, GitHub, and open source, no experience with APIs or web frameworks. I am most interested in issues about data, metrics, or visualization. I want to learn data tools like Dagster and Superset, and how AI web
applications are built. Prefer small, clearly described issues:
documentation, tests, or small Python bug fixes. Rank last:
frontend work (JavaScript/CSS), CI or Docker setup, and changes
